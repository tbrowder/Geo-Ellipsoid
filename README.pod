...
=for HTML <a href="https://travis-ci.org/tbrowder/Geo-Ellipsoid-Perl6"><img src="https://travis-ci.org/tbrowder/Geo-Ellipsoid-Perl6.svg?branch=master"></a>
...
=head2 RELEASE NOTES (from the original CPAN version)
